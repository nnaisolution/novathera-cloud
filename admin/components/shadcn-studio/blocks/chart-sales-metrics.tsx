...
import { IconTrendingUp, IconRosetteDiscount, IconCurrencyDollar, IconShoppingBag, IconChartAreaLine, IconCirclePercentage } from '@tabler/icons-react'
...
const MetricsData = [
  ...
  {
    icons: (
      <IconRosetteDiscount className='size-5' />
    ),
            ...
            <div className='flex flex-col gap-6 text-lg md:col-span-4'>
              ...
              <div className='grid gap-6 md:grid-cols-2'>
                <div className='flex items-center gap-2'>
                  <IconChartAreaLine className='size-6' />
                  <span className='text-lg font-medium'>Open Statistics</span>
                </div>
                <div className='flex items-center gap-2'>
                  <IconCirclePercentage className='size-6' />
